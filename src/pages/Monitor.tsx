        ...
        <div>
          ...
          <div className="relative ml-auto mr-auto px-7 py-7">
            ...
            <img
              src={device_photo}
              alt="Device"
              className={`max-w-[300px] md:max-w-[900px] w-full h-auto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-opacity duration-700 ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-9 mt-12 max-w-[1200px] w-full mx-auto px-4">
            {uses.map((use, i) => (
             ...
             <p className="mx-10 px-11 text-center text-2xl py-8 rounded-xl bg-opacity-10 bg-[#0263a0]">
